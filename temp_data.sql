...
-- 5. 客户表数据
INSERT INTO customer (name, contact_person, phone, status) VALUES
('北京科技有限公司', '陈总', '13500135001', 1),
('上海贸易公司', '吴经理', '13400134002', 1),
('广州电子科技', '郑主任', '13300133003', 1),
('成都教育机构', '刘校长', '13200132004', 1);
...
-- 13. 应收账款数据（新增）
INSERT INTO account_receivable (order_id, customer_id, amount, status, due_date, created_date) VALUES
(1, 1, 9898.00, 'pending', DATE_ADD(NOW(), INTERVAL 30 DAY), NOW()),
(3, 3, 7999.00, 'paid', DATE_ADD(NOW(), INTERVAL -10 DAY), NOW()),
(4, 4, 1525.00, 'pending', DATE_ADD(NOW(), INTERVAL 30 DAY), NOW());

-- 14. 应付账款数据（新增）
INSERT INTO account_payable (order_id, supplier_id, amount, status, due_date, created_date) VALUES
(1, 1, 17997.00, 'paid', DATE_ADD(NOW(), INTERVAL -5 DAY), NOW()),
(2, 2, 15996.00, 'pending', DATE_ADD(NOW(), INTERVAL 25 DAY), NOW()),
(4, 4, 430.00, 'pending', DATE_ADD(NOW(), INTERVAL 30 DAY), NOW());